...
namespace GarbageMonitorSystem.Api
{
    ...
    [ApiController]
    public class GarbagePointController : ControllerBase
    {
        private readonly IDistributedCache _cache;

        public GarbagePointController(IDistributedCache cacheservice)
        {
            _cache = cacheservice;
        ...
        [HttpGet]
        public IActionResult Get(int offset,int limit=20,int category=2)
        {
            List<SqlParameter> param = new List<SqlParameter>
            {
                ...
                new SqlParameter("@Type", SqlDbType.NVarChar) { Value = "Bin" } , // Default value
            ...
            _cache.SetString($"GarbagePoint_GET_{offset}_{limit}", JsonConvert.SerializeObject(returndata), new DistributedCacheEntryOptions() { AbsoluteExpirationRelativeToNow = expiration });
