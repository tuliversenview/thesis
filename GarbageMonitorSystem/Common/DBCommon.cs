...
namespace GarbageMonitorSystem.Common
{
    public class DBCommon
    {
        ...
        public static int Update<T>(T obj, List<string> listpropertiesupdate)
        {
            ...
            using (SqlConnection connection = new SqlConnection(ProjectConfig.ConnectionString))
            {
                ...
                foreach (PropertyInfo property in objectProperties)
                {
                    ...
                    {
                        updateExpressions.Add($"[{propertyName}] = GETDATE() AT TIME ZONE 'UTC' AT TIME ZONE 'SE Asia Standard Time'");
                    }
        ...
        public static (User,bool) ValidateUserCredentials(string username, string password)
        {
            User u = new User();
            bool isValid = false;
            List<SqlParameter> sqlParameters = new List<SqlParameter>
            {
                ...
                new SqlParameter("@returnValue", SqlDbType.Bit) { Direction = ParameterDirection.Output }
            };
            ...
            using (SqlConnection connection = new SqlConnection(ProjectConfig.ConnectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("ValidateUserCredentials", connection))
                {
                    ...
                    try
                    {
                        ...
                        isValid = (bool)command.Parameters["@returnValue"].Value;
                        return (u, isValid);
                    }
